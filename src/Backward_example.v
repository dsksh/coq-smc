...
(*Definition backward_post (I : prop) (T : trans) (P : prop) (k: nat) : Prop :=
  lasso_bwd_conj T P (S k) /\ safety_k_ni I T P (S k).
*)
...
Proof.
  unfold ex1_I, ex1_T, ex1_P.
  unfold backward_post_conj, lasso_bwd_conj, safety_k_conj, prop_k_init_conj, loop_free, path, no_loop, no_loop', sseq, nth, state.
  repeat rewrite -> Nat.add_0_l;
  repeat rewrite -> Nat.add_0_r.
